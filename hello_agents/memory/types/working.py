...
class WorkingMemory(BaseMemory):
    ...
    def add(self, memory_item: MemoryItem) -> str:
        ...
        # 添加到堆中（加自增计数器避免 MemoryItem 直接比较）
        self._heap_counter = getattr(self, '_heap_counter', 0) + 1
        heapq.heappush(self.memory_heap, (-priority, memory_item.timestamp, self._heap_counter, memory_item))
    ...
    def _update_heap_priority(self, memory: MemoryItem):
        ...
        for mem in self.memories:
            ...
            heapq.heappush(self.memory_heap, (-priority, mem.timestamp, self._heap_counter, mem))
